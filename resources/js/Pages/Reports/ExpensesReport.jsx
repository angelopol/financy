...
export default function ExpensesReport({ auth, items, from, to, provider, totalAmount }) {
    ...
    const handlePrint = () => {
        ...
        if (!w) return;
        w.document.open();
        w.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Expenses Report</title>
            <style>
    ...
    return (
        <AuthenticatedLayout user={auth} header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Expenses Report</h2>}>
