...
export default function Earnings({ auth, OneTimeEarnings, RecurringEarnings, rates, projectId = null, filters = {}, recurringTotals = {} }) {
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <form onSubmit={(e) => { e.preventDefault(); router.get(route('earnings.index'), { q: search, project_id: projectId || undefined }, { preserveState: true }); }} className="mb-5 flex gap-2">
                            ...
                            <div className="flex justify-end items-center gap-2 mt-4">
                                <CreateEarningModal projectId={projectId} />
